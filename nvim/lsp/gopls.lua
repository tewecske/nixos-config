...
-- Adapted from nvim-lspconfig's lsp/gopls.lua. The root_dir logic below is
-- upstream's verbatim: it keeps files opened from GOMODCACHE / GOROOT attached
-- to the already-running client instead of spawning one per dependency.
-- Settings are the ones carried over from the old init.lua.
